...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=newtonschool%20video&key=AIzaSyAmIcOYrStax8lQaFbimDplqi86zb7WQkw&maxResults=20`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyAmIcOYrStax8lQaFbimDplqi86zb7WQkw&maxResults=20`);
let data = await res.json();
